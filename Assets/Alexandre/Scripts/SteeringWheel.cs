...
{
    public SentinelController SentinelControllerReference;
    ...
    void Update()
    {
        ...
        // Envoyer la vitesse de rotation au SentinelController
        if (SentinelControllerReference != null)
        {
            SentinelControllerReference.UpdateRotation(GetClampedValue());
        }
